...
class CoolSystem(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.save_path='save_image/save_dmap'
    ...
    def training_step(self, batch, batch_idx):
        ...
        batch = torch.cat([x_init, residual_gt], dim = 1)
    ...
    def validation_step(self,batch,batch_idx):
        ...
        # with torch.no_grad():
        semantic_code = self.semantic_encoder(x_init)
        samples_residual,preds = self.DiffSampler.sample_high_res(x_init, guided_fts = semantic_code)
    ...
    def val_dataloader(self):
        val_set = DPDD_valid(self.validation_datasets,train=False,size=320,crop=False)
...
def main(): 
    ...
    config_path = r'../option/NAFNetAlign_dmap.yaml'
    ...
    output_dir = '/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetAlign_dmap'
