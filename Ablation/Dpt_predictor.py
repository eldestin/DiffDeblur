...
class CoolSystem(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.save_path='/hpc2hdd/home/hfeng108/Archive/save_image/save_img_dp'
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Train Depth_predictor to predict gt with blur input
            # Then fixed depth predictor
            init_guide_res = self.depth_predictor(init_blur_guide)
        # Residual learning
        init_guide = init_guide_res + init_blur_guide
    ...
    def validation_step(self,batch,batch_idx):
        ...
        save_image(samples[:2,...],os.path.join(self.save_path, filename))      
    # if batch_idx==0:
    ...
    # if batch_idx==0:
        ...
        self.log('psnr_init',psnr_init)
        self.log('ssim_init',ssim_init)
        self.log('lpips_score_init',lpips_score_init)
        self.log('psnr',psnr)
        self.log('ssim',ssim)
    ...
    def val_dataloader(self):
        val_set = DPDD_valid(self.validation_datasets,train=False,size=512,crop=False)
...
def main(): 
    print("Crop to 512 with 5 as validation step")
    Val=False
    ddp = DDPStrategy(process_group_backend="nccl", find_unused_parameters = True)
    config_path = r'/hpc2hdd/home/hfeng108/Archive/option/NAFNetAlign_guidance.yaml'
    ...
    # path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidance/Defocus_delburring_initial/version_10/checkpoints/epoch12194-PSNR-26.166-SSIM-0.8116-lpips_score-0.1497.ckpt"
    ...
    output_dir = '/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidance'
    ...
    #     )
    # else:
    # resume_checkpoint_path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidance/Defocus_delburring_initial/version_14/checkpoints/epoch1049-PSNR-26.311-SSIM-0.8159-lpips_score-0.1499.ckpt"
    ...
    # val_path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidance/Defocus_delburring_initial/version_14/checkpoints/epoch1049-PSNR-26.311-SSIM-0.8159-lpips_score-0.1499.ckpt"
