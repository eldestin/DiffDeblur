'''
This is the implementation of ablation study which more focus on semantic guidance mention in paper;
...
import lpips
from utils.BlurDataset import DPDD, LFDOF, DPDD_cat, DPDD_cat_valid,DPDD_valid
...
class CoolSystem(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.save_path='/hpc2hdd/home/hfeng108/Archive/save_image/save_semantic'
    ...
    def training_step(self, batch, batch_idx):
        ...
        sample_pred = self.model(noisy_images, timesteps)
    ...
    def validation_step(self,batch,batch_idx):
        ...
        # with torch.no_grad():
        # semantic_code = self.semantic_encoder(x_init)
        samples_residual,preds = self.DiffSampler.sample_high_res(torch.cat([x_init, init_guide], dim = 1), guided_fts = None)
        ...
        if batch_idx==0:
            filename = "x_init_{}.png".format(self.current_epoch)
            save_image(x_init[:2,...],os.path.join(self.save_path, filename))
        if batch_idx==0:
            filename = "init_guide{}.png".format(self.current_epoch)
    ...
    def val_dataloader(self):
        val_set = DPDD_valid(self.validation_datasets,train=False,size=320,crop=True)
...
def main(): 
    ...
    config_path = r'../option/NAFNetAlign_sem.yaml'
    ...
    output_dir = '/hpc2hdd/home/hfeng108/Archive/lgs/NAFNet_semantic'
