...
class CoolSystem(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.save_path='/hpc2hdd/home/hfeng108/Archive/save_image/save_realdof'
    ...
    def training_step(self, batch, batch_idx):
        ...
        # condition on align image (3 + 1 + 3 = 7)
    ...
    def validation_step(self,batch,batch_idx):
        ...
        # dpt = self.depth_model(x)
        # # dpt_l = (dpt_l > self.threshold).float()
        # # dpt_r = (dpt_r > self.threshold).float()
        # inp = torch.cat([x, dpt], dim = 1)
        # inp = torch.cat([x, dpt], dim = 1)
        dpt = self.max_min_normalize(self.depth_model(x))
        # directly concat as guidance input
        ...
        # psnr_align = PSNR(x.float(), gt.float())
        # ssim_align = SSIM(x.float(), gt.float())
        # lpips_score_align = self.lpips_score_fn(x.float(), gt.float())
    ...
    # if batch_idx==0:
        filename = "target_{}.png".format(name)
        ...
        self.log('psnr',psnr)
        self.log('ssim',ssim)
        self.log('lpips_score',lpips_score)
        # psnr, ssim = 0, 0
    ...
    def val_dataloader(self):
        val_set = Realdof(path="/hpc2hdd/home/hfeng108/FHX/realdof", train=False, crop=False)
...
def main(): 
    ...
    config_path = r'/hpc2hdd/home/hfeng108/Archive/option/NAFNetAlign_guidance_realdof.yaml'
    ...
    output_dir = '/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidancecat_cuhk'
    ...
    # if Val == True:
    #     trainer.validate(
    #         model,ckpt_path=config.val_ckpt_path
    #     )
    # else:
    # resume_checkpoint_path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidancecat/Defocus_delburring_initial/version_26/checkpoints/epoch204-PSNR-26.520-SSIM-0.8282-lpips_score-0.1411.ckpt"
    # resume_checkpoint_path ="/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidancecat/Defocus_delburring_initial/version_131/checkpoints/epoch3029-PSNR-24.627-SSIM-0.7488-lpips_score-0.2461.ckpt"
    # trainer.fit(model,ckpt_path=resume_checkpoint_path)
    # val_path=r'/home/fhx/code/archive/lgs/NAFNetAlign/Conv/Defocus_delburring_initial/version_2/checkpoints/epoch10274-PSNR-23.334-SSIM-0.7563-lpips_score-0.1991.ckpt'
    # val_path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidancecat/Defocus_delburring_initial/version_30/checkpoints/epoch04-PSNR-26.689-SSIM-0.8195-lpips_score-0.1632.ckpt"
    # val_path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidancecat/Defocus_delburring_initial/version_28/checkpoints/epoch1044-PSNR-26.288-SSIM-0.8212-lpips_score-0.1411.ckpt"
    # trainer.validate(model,ckpt_path=val_path)
    # #trainer.fit(model,ckpt_path=val_path)
    val_path = "/hpc2hdd/home/hfeng108/Archive/lgs/NAFNetguidancecat/Defocus_delburring_initial/version_28/checkpoints/epoch1044-PSNR-26.288-SSIM-0.8212-lpips_score-0.1411.ckpt"
    trainer.validate(model,ckpt_path=val_path)
