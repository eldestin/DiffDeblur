...
import lpips
from utils.BlurDataset import DPDD, LFDOF, DPDD_cat, DPDD_cat_valid,DPDD_valid, CUHK_blur
...
class CoolSystem(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.save_path='/hpc2hdd/home/hfeng108/Archive/save_image/save_pixeldp'
    ...
    def val_dataloader(self):
        val_set = CUHK_blur("/hpc2hdd/home/hfeng108/FHX/PixelDP",train=False,size=512,crop=False)
...
def main(): 
    ...
    config_path = r'../option/NAFNetAlign_guidance_cuhk.yaml'
    ...
    output_dir = '../lgs/NAFNetguidancecat_cuhk'
